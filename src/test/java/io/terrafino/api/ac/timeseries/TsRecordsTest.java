...
public class TsRecordsTest {
    ...
    public void canCreateTsRecordsFromListOk() throws Exception {
        TsRecords records = new TsRecords(attributes, Arrays.asList(record1, record2));
    ...
    public void throwsExceptionWhenAttributesDoNotMatchAcrossAllRecords() throws Exception {
        ...
        thrown.expectMessage("Given arguments must match those of all records!");
        new TsRecords(twoAttributes, Arrays.asList(twoAttributeRecord, oneAttributeRecord));
    }
    ...
    public void equalsReturnsTrueForEqualRecords() throws Exception {
        TsRecords recordsA = new TsRecords(attributes, Arrays.asList(record1, record2));
        ...
        TsRecords recordsB = new TsRecords(attributes, Arrays.asList(record1b, record2b));
    ...
    public void equalsReturnsFalseForRecordsWithDifferentAttributes() throws Exception {
        ...
        TsRecords recordsB = new TsRecords(attributesB, Arrays.asList(record1b, record2b));
